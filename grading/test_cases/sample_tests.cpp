...
/* Test 1 - Provided Tests Using multiplyMatrices */
...
/**
 * Identity multiplication reversed
 * I * A = A
 */
TEST(Test01, testB)
{
...
/* Test 2 - Provided Tests using multiplyMatricesPtr */
...
/* Test 3 - Provided Transpose Tests */
// ----------------------------------------

/**
 * Simple transpose with a square 2x2 matrix.
 */
TEST(Test03, testA)
{
    double **result;
...
/**
 * Tranpose with a square 3x3 matrix.
 */
TEST(Test03, testB)
{
    double **result;
...
/**
 * Tranpose with a rectangular 2x3 matrix.
 */
TEST(Test03, testC)
{
    double **result;
...
/* Test 4 - Matrix Multiplication with Double Values */

/**
 * Multiplciation with double values less than 1.
 */
TEST(Test04, testA)
{
    double a[20] = {
